...
def get_short_history_index_stocks():
    """
    日経225 or JPX400 構成銘柄のうち、直近10年に満たない履歴しか
    持っていない銘柄を取得する。
    """
    ...
    WHERE sm.active = 1
      AND (sm.nikkei225 = 1 OR sm.jpx400 = 1)
    GROUP BY sm.code
...
def main():
    ...
    print("=" * 40)
    print("日経225/JPX400 10年データ拡張開始")
    print("=" * 40)

    stocks = get_short_history_index_stocks()
